    ...
    public class Program
    {
        ...
        public static void Main(string[] args)
        {
            ...
            while (true)
            {
                ...
                {
                    Console.WriteLine($" {ex.Message} USER ID {ex.UserId} {404}"); //Message to the user 
                    Console.WriteLine($"LOG : {ex.Message}");
                    Console.WriteLine($"LOG : {ex.StackTrace}");
                }
                catch (Exception ex)
                {
                    Console.WriteLine($"SOME ERROR OCCURED  RESPONSE CODE {500}"); //Message to the user 
                    Console.WriteLine($"LOG : {ex.Message}");
                    Console.WriteLine($"LOG : {ex.StackTrace}");
                }
            }
        ...
        static void CreateOrder()
        {
            ...
            int orderId = new OrderService().CreateOrderWithError(userId);
...
Cachea load < User 1 was deleted> Order creation 
